...
keygen(std::span<const uint8_t, seedBytes> seedA,  // step 1
  ...
  requires(saber_params::validate_pke_keygen_args(L,
                                                  EQ,
                                                  EP,
                                                  MU,
                                                  seedBytes,
                                                  ...
                                                  uniform_sampling))
{
  ...
  auto s =
    mat::poly_matrix_t<L, 1, Q>::template gen_secret<uniform_sampling, noiseBytes, MU>(
      seedS);
...
encrypt(std::span<const uint8_t, 32> msg,
  ...
  requires(saber_params::validate_pke_encrypt_args(L,
                                                   EQ,
                                                   EP,
                                                   ET,
                                                   MU,
                                                   ...
                                                   uniform_sampling))
{
  ...
  auto s_prm =
    mat::poly_matrix_t<L, 1, Q>::template gen_secret<uniform_sampling, seedBytes, MU>(
      seedS);
